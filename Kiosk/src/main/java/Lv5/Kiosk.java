        ...
        do {
            ...
            switch (menuItemChoice) {
                case 0:
                    ...
                    return;
                default:
                    if (menuItemChoice >= 1 && menuItemChoice <= menu.getMenuItems().size()) {
                        MenuItem selectedItem = menu.getMenuItems().get(menuItemChoice);
                        System.out.printf("선택한 메뉴: " + selectedItem.getMenuName() +" | "+ selectedItem.getPrice() +" | "+ selectedItem.getMenuDescription());
                        System.out.println();
                        System.out.println("----------------------------------------------------------------------------------");
                        return;
                    } else {
